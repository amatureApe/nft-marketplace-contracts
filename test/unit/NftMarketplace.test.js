  ...
  : describe("Nft Marketplace Unit Tests", function () {
    ...
    describe("cancelListing", function () {
      it("reverts if there is no listing", async function () {
        ...
        await expect(
          nftMarketplace.cancelListing(basicNft.address, TOKEN_ID)).to.be.revertedWith(error);
      });
      it("reverts if anyone but the owner tries to call", async function () {
        ...
        await basicNft.approve(user.address, TOKEN_ID);
        await expect(
          nftMarketplace.cancelListing(basicNft.address, TOKEN_ID)).to.be.revertedWith("NotOwner");
      });
      it("emits an event and removes the listing", async function () {
        await nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE);
